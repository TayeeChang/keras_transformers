...
def get_encoder_component(name,
    ...
    feed_forward_layer = _wraper_layer(
...
def build_transformer_model(config_file,
                            checkpoint_file,
                            trainable=True,
                            seq_len=int(1e9),
                            with_nsp=False,
